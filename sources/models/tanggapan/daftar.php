...
$dataPengaduan = mysqli_fetch_assoc($resultPengaduan);
            ...
            <div class="col-sm">
              <div class="card">
                ...
                <div class="card-body">
                            ...
                            <tr>
                              ...
                              ?>
                                <td class="text-center align-middle">
                                  <div class="btn-group">
                                    <a class="btn btn-app bg-danger m-0" href="./hapus.php?id=<?php echo $id; ?>&idPengaduan=<?php echo $idPengaduan; ?>">
                  ...
                  if ($dataPengaduan["status"] == "diproses") {
                  ?>
                    <a class="btn btn-primary btn-block mt-1" href="./buat.php?id=<?php echo $idPengaduan; ?>"><i class="fa fa-plus"></i> Buat</a>
                  <?php
                  }
                  ?>
